const iconPaths = {
  ...
  setups: (
    <>
      <path d="M5 8.5h6.5" />
      <path d="M12.5 8.5h6.5" />
      <path d="M8.25 5.25v6.5" />
      <path d="M15.75 5.25v6.5" />
      <path d="M8.25 15.5c2.1-1.9 4.1-2.9 6-2.9 1.8 0 3.6.9 5.2 2.9" />
      <path d="M4.8 18.8c1.8-3 4.4-4.6 7.3-4.6" />
    </>
  ),
  reports: (
    <>
